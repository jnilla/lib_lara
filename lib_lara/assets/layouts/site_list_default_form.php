							...
							<td <?php echo $attribs; ?>>
								...
								<?php else : ?>
									...
									<?php if ($addLink && ($canEdit || $canEditOwn)) : ?>
										<?php // Add edit link ?>
										<a href="<?php echo JRoute::_("index.php?option=com_$componentNameInLowerCase&view=$singularNameInLowerCase&task=$singularNameInLowerCase.edit&id=".$item->id."&return=$return"); ?>"
